...
RIVEN.create = (append = true) => {
  ...
  Ø('model').create({ x: 12, y: 4 }, lib.Mesh, [
    ...
    Ø('asulodeta').create({ x: 12, y: 8 }, lib.Table, tablatal, Yleta),
  ...
  Ø('view').create({ x: 49, y: 4 }, lib.Mesh, [
    ...
    Ø('credits').create({ x: 21, y: 8 }, lib.Dom, 'div', `
      <a target='_blank' href="https://twitter.com/Vega_DW" class="icon twitter external"></a>
      <a target='_blank' href="https://github.com/VegaDeftwing" class="icon github external"></a>      
      <a target='_blank' href="https://chaos.social/@vega" class="icon merveilles external"></a>
      ...
      <a data-goto='vega' href='#vega'>Vega Deftwing</a> © ${new Arvelie('19J02').toString(true)}—${arvelie()}
